...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "AdIntel Gaming — Mobile Ad Intelligence" },
      { name: "description", content: "Track competitor creatives, performance signals, and spend across mobile gaming ad networks." },
      { name: "author", content: "AdIntel Gaming" },
      { property: "og:title", content: "AdIntel Gaming — Mobile Ad Intelligence" },
      ...
      { name: "twitter:title", content: "AdIntel Gaming — Mobile Ad Intelligence" },
