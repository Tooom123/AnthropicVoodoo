      ...
      <div className="mx-auto max-w-3xl space-y-12 py-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-base text-slate-500 max-w-xl mx-auto">
            Analyse les créatifs publicitaires du marché mobile, détecte les archétypes
            en tendance et génère des briefs prêts à tester — en quelques secondes.
          </p>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="Ex: Candy Crush Saga, Subway Surfers…"
          ...
          {reports && reports.length > 0 && (
            <div className="flex flex-wrap gap-1.5">
              <span className="text-[11px] text-slate-400 self-center">Récents :</span>
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            { label: "Jeux Voodoo suivis", value: totalGames, color: "text-indigo-600" },
            { label: "Live ads scannées", value: totalAds.toLocaleString(), color: "text-emerald-600" },
            { label: "Archétypes détectés", value: totalArchetypes, color: "text-violet-600" },
          ...
          {[
            {
              icon: LayoutGrid,
              title: "Ad Library",
              desc: "Browse tous les créatifs concurrents par réseau.",
              to: "/ads",
            },
            {
              icon: Target,
              title: "Competitive Scope",
              desc: "Qui dépense quoi, où et sur quel réseau.",
              to: "/competitive",
            },
            {
              icon: Compass,
              title: "Global Market Map",
              desc: "Carte d'intensité mondiale des dépenses UA.",
              to: "/geo",
            },
